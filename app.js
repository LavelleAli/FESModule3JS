...
//  Example:
console.log(
  "Hello World!!" + "My name is Lavelle Ali" + " and I am 35 years old",
);
...
if (cash > price) {
  ...
  console.log(
    `You don't have enough cash for this item. You still owe ${change * -1} dollars`,
  );
}
...
if (cash2 >= price2 && isStoreOpen === true) {
  ...
  console.log(
    `You do not have enough money for this item, you still owe ${difference * -1} dollars.`,
  );
} else if (cash2 <= price2 && isStoreOpen === false) {
  console.log(`Store is closed`);
}

//  "||" is an  "or" opereator and checks if the left OR right side of the comparison if true
...
let buy =
  cash5 >= price5 && isStoreOpen3 ? "give receipt" : "do not give receipt";
console.log(buy);
